...
const MoverCard = ({image, name, phone, email, loadArea, rating, reviewCount, price, hiresCount, description}) => {
    ...
    <div className="flex border-[2px] rounded-[30px] py-[0px] shadow-xl overflow-hidden pb-[20px] w-full">
      <div className="flex flex-col w-full">
        ...
        <div className="flex flex-col xl:flex-row xl:items-center xl:space-x-[0px] mb-[20px] xl:mb-[0px] xl:py-[10px]">
          {/* image + details */}
          <div className="flex flex-col md:flex-row md:items-center px-[20px] md:flex-[3] md:space-x-[15px] mb-[20px] sm:mb-[10px] md:mb-[0px]">
            {/* image */}
            ...
            <div className="flex flex-col w-full flex-[2]">
              {/* mover name */}
              <div className="flex items-center justify-between w-full pr-[20px] mb-[5px] sm:mb-[10px]">
              ...
              {/* rating / reviews */}
              <div className="flex flex-col lg:flex-row lg:items-center space-y-[5px] lg:space-y-0 lg:space-x-[10px] mt-[0px] text-[15px]">
          ...
          <div className="flex md:flex-[1]">
            <div className="flex space-x-[20px] md:space-x-0 justify-between w-full xl:flex-col border border-primary rounded-[20px] xl:items-center xl:justify-center md:flex-[1] py-[10px] xl:py-[20px] mx-[20px] md:mx-[30px] xl:mx-[0px] xl:mr-[30px] px-[10px] sm:px-[20px] xl:px-[0px]">
              ...
              <div className="flex space-x-[10px] items-center md:justify-center bg-primary/10 py-[5px] px-[10px] md:px-[30px] xl:px-[10px] rounded-[10px] xl:mt-[10px]">
        ...
        >
          ...
          {/* check out */}
          <div className="btn btn-primary w-auto">Check Out</div>
        </div>
      </div>
    </div>
  );
