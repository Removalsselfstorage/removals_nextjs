  ...
  return (
    <div className="mb-[0px] lg:mb-[20px] mt-[40px]">
      <div className="md:max-w-7xl mx-auto">
        {/* Features*/}
        <div className="border-[2px] rounded-[30px] border-secondary py-[20px] md:py-[30px] px-[20px] lg:px-[100px] xl:px-[20px] grid grid-cols-2 md:grid-cols-2  lg:grid-cols-2 xl:grid-cols-4 justify-center mx-[10px] md:mx-[20px] gap-x-[20px] gap-y-[20px] md:gap-[30px]">
