...
export const fetchAllStorage = async () => {
  const storageRef = collection(db, "storageData");
  // const docSnap = query(storageRef, orderBy("createdAt", "asc"));
  const docSnap = query(storageRef);
