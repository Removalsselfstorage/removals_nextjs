...
const EditProfile = () => {
  ...
  useEffect(() => {
    ...
    setImageName(singleMoversData?.personalDetails?.profilePictureName);
    setPersonalBio(singleMoversData?.personalDetails?.personalBio);
    setAddress(singleMoversData?.personalDetails?.address);
    setFirstName(singleMoversData?.personalDetails?.firstName);
    setLastName(singleMoversData?.personalDetails?.lastName);
    setEmail(singleMoversData?.personalDetails?.email);
    setPhone(singleMoversData?.personalDetails?.phone);
  }, [singleMoversData]);
