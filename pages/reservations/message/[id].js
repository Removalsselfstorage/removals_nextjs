...
const MessageDetails2 = ({ progressData }) => {
  ...
  return (
    <BookingLayout>
      ...
      {progressData && (
        <div className='mb-[0px] lg:mb-[0px] pt-[80px] md:pt-[80px] '>
          <div className='bg-white/90 py-[50px] md:mx-[0px] w-full min-h-[100vh] overflow-x-none px-[0px] md:px-[30px]'>
            ...
            <div
              ...
              className='relative px-[0px] md:pl-[20px]  bg-gray-100 border  rounded-[10px] shadow-lg pb-[70px] pt-[0px]'
            >
              <div
                ref={messagesContainerRef}
                className='overflow-y-auto pt-[20px] overflow-x-none h-[100vh] xl:h-[90vh] pr-[5px] md:pr-[20px] scrollbar-track-primary/10 scrollbar-thumb-primary/90 scrollbar-thin overflow-hidden  mx-[10px] '
              >
                {messages?.map((ms) => {
                  // Parse the date string into a Date object
                  ...
                  return (
                    <div
                      className={`${
                        ms.userType === "user" ? "items-start" : "items-end"
                    ...
                    >
                      <div
                        ...
                        }  px-[20px] py-[20px] min-w-[300px] w-fit my-[5px] rounded-bl-[20px] rounded-br-[20px] shadow-lg`}
                      >
                        <p className='font-bold mb-[10px]'>
                          {ms.userType === "user" ? "Me" : ms.user}
                        </p>
